...
const ServiceDetails = () => {
   ...
   // show all reviews 
   useEffect(() => {
      fetch(`https://kowshik-photography-serverside.vercel.app/allreviews/${id}`)
         .then(res => res.json())
   ...
   const handleAddReviewBtn = (event) => {
      ...
      fetch(`https://kowshik-photography-serverside.vercel.app/service/${id}`, {
         method: 'POST',
         headers: {
   ...
   const handleRecentReviewBtn = () => {
      fetch(`https://kowshik-photography-serverside.vercel.app/serviceByTime/${id}`)
         .then(res => res.json())
         .then(data => setReview(data))
   }
